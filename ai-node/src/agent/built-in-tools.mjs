...
export const BUILT_IN_TOOL_METADATA = Object.freeze([
  ...
  defineToolMetadata({ name: "workspace.list", displayName: "List workspace files", risk: "READ", approvalPolicy: "none", category: "workspace" }),
  ...
  defineToolMetadata({ name: "workspace.word.inspect", displayName: "Inspect Word document", risk: "READ", approvalPolicy: "none", category: "document" }),
  defineToolMetadata({ name: "workspace.word.patch", displayName: "Modify Word document", risk: "WRITE", approvalPolicy: "none", category: "document" }),
