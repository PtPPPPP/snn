...
function publicFile(file) { return Object.freeze({ fileId: file.fileId, originalName: file.originalName, virtualPath: file.virtualPath, size: file.size, kind: file.kind, contentType: file.contentType, updatedAt: file.updatedAt ?? 0 }); }
