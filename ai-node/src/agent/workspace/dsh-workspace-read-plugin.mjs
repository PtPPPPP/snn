...
/** DSH schedules these tools; canonical authorization remains SNN-owned and read-only. */
export function apply(ctx, config = {}) {
  ...
  ctx.tools.register(defineTool({
    ...
    description: "Extract bounded text from an uploaded PDF, DOCX, or XLSX document stored in the assigned SNN workspace. Text files belong to workspace.read instead.",
