...
//
// Resolution order in lib/ai-client.ts / lib/agent-client.ts:
//   1. window.__SNN_AI_API_BASE_URL__ / window.__SNN_AGENT_API_BASE_URL__ (this file)
//   2. build-time env (NOT viable: vite replaces process.env with {} in the
//      client bundle, so NEXT_PUBLIC_* never resolves)
//   3. fallback "/api/ai" / "/api/agent" (same-origin; requires a Worker/API proxy)
//
...
window.__SNN_AGENT_API_BASE_URL__ = "https://api.snnai.cn/api/agent";
