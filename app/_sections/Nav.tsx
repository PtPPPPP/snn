...
const links=[['/','首页'],['/#projects','项目'],['/#activities','活动'],['/#join','加入'],['/ai','SNN AI'],['/#learning-lab','学习实验室']];
